...
<script>
 ...
 var file_nomias = '<?php echo 'upload/'.$_FILES["file"]["name"]; ?>';
...
//camera.updateProjectionMatrix();
  ...
  // scene.add(fix_mesh2);
    ...
    webglRenderer.domElement.style.position = "relative";
	 webglRenderer.domElement.style.bottom = 90;
...
<form action="" method="post" enctype="multipart/form-data" style="position:relative;z-index:9999999;top:91%;">
